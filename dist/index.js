...
var DragifyContext = React.createContext(undefined);
var DragifyProvider = function (_a) {
    var children = _a.children, onDragStart = _a.onDragStart, onDragEnd = _a.onDragEnd;
    var _b = React.useState(null), draggedItem = _b[0], setDraggedItem = _b[1];
    var _c = React.useState(false), isDragging = _c[0], setIsDragging = _c[1];
    var handleDragStart = React.useCallback(function (start) {
        onDragStart === null || onDragStart === void 0 ? void 0 : onDragStart(start);
    }, [onDragStart]);
    var handleDragEnd = React.useCallback(function (result) {
        setIsDragging(false);
        setDraggedItem(null);
        onDragEnd(result);
    }, [onDragEnd]);
    return (React__default["default"].createElement(DragifyContext.Provider, { value: {
...
var useDragifyContext = function () {
    var context = React.useContext(DragifyContext);
    if (!context) {
...
var useDraggable = function (options) {
    ...
    var initialPosition = React.useRef(null);
    React.useEffect(function () {
        return function () {
            initialPosition.current = null;
        };
    }, []);
    var getDragHandleProps = React.useCallback(function () { return ({
    ...
    var cancelDrag = React.useCallback(function () {
        var _a;
        var element = elementRef.current;
